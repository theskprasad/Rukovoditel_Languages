...
define('TEXT_FILTER_BY_DAYS_TOOLTIP','You can use <code>+1</code> and it means Today+1. There rule can be <code>-1</code>. Also you can set several days like <code>-1&2&3</code>, <code>>=0</code>, <code>>0&<0</code>.');
...
define('TEXT_VERSION_INFO','You are using Rukovoditel');
...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Enter icon name from  <a href="https://fontawesome.com/v4/icons/" target="_blank">Font Awesome</a> or <a href="https://icons8.com/line-awesome" target="_blank">Line Awesome</a> lib.<br>For example: fa-bell or la-bell.');
...
define('TEXT_FILTER_BY_MONTH_TOOLTIP','Available values: <code>0</code> - the current month, <code>-1</code> - the previous month, <code>+1</code> - next month. You can also specify multiple values: <code>-1&2&3</code>, <code>>=0</code>, <code>>0&<0</code>');
define('TEXT_FILTER_BY_YEAR_TOOLTIP','Available values: <code>0</code> - this year, <code>-1</code> - the previous year, <code>1</code> - next year. You can also specify multiple values: <code>-1&2&3</code>, <code>>=0</code>, <code>>0&<0</code>');
...
define('TEXT_FILTER_BY_WEEK_TOOLTIP','Available values: <code>0</code> - the current week, <code>-1</code> - the previous week, <code>+1</code> - next week. You can also specify multiple values: <code>-1&2&3</code>, <code>>=0</code>, <code>>0&<0</code>.');
...
define('TEXT_CHOICES_VALUE_INFO','The value can be used in formula calculations. <a href="https://docs.rukovoditel.net/index.php?p=25#get_value" target="_blank">Read more</a>');
...
define('TEXT_JS_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href="https://docs.rukovoditel.net/index.php?p=72" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ASSIGN_USER_TO_MULTIPLE_GROUPS','Assign a user to multiple groups');
define('TEXT_ASSIGN_USER_TO_MULTIPLE_GROUPS_INFO','The user will be able to switch between groups in his personal account. <a href="https://docs.rukovoditel.net/index.php?p=116" target="_blank"><u>Read more.</u></a>');
define('TEXT_DISPLAY_USER_GROUP_IN_MENU','Display the name of the access group in the menu');
define('TEXT_CHANGE_ACCESS_GROUP','Сhange access group');
define('TEXT_LOGIN_AS_USER','Login as');
define("TEXT_HOURLY",'Hourly');
define('TEXT_DISTANCE','Distance');
define('TEXT_CALCULATE_TOTAL_DISTANCE','Calculate total distance');
define('TEXT_KILOMETERS','Kilometers');
define('TEXT_MILES','Miles');
define('TEXT_TOTAL_DISTANCE_IN_KILOMETERS','Total distance in kilometers');
define('TEXT_TOTAL_DISTANCE_IN_MILES','Total distance in miles');
define('TEXT_SAVE_VALUE','Save value');
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_SAVE_VALUE_TIP','Select numeric field to save distance. The value will be saved in background after map rendered.');
define('TEXT_ERROR_LIB','PHP <b>%s</b> library is NOT installed on your web server');
define('TEXT_EXTNER_VALUE_IN_PERCENT_OR_PIXELS','Enter a value in percentages or pixels. For example: 50 or 50%');
define('TEXT_SOCIAL_LOGIN','Social login');
define('TEXT_ENABLE_SOCIAL_LOGIN','Enable social login');
define('TEXT_ENABLE_SOCIAL_LOGIN_ONLY','Use social login only');
define('TEXT_SELECT_SOCIAL_NETWORKS','Select social networks');
define('TEXT_APP_ID','APP ID');
define('TEXT_VKONTAKTE','Vkontakte');
define('TEXT_SECRET_KEY','Secret Key');
define('TEXT_LOGIN_WITH','Login with');
define('TEXT_CREATE_USER','Create a user');
define('TEXT_CREATE_USER_AUTOMATICALLY','Automatically create user');
define('TEXT_REDIRECT_TO_PUBLIC_REGISTRATION','Redirect to public registration form');
...
define('TEXT_SOCIAL_LOGIN_INFO','On this page, you can configure authorization via popular social networks. <a href="https://docs.rukovoditel.net/index.php?p=118" target="_blank"><u>Read more.</u></a>');
define('TEXT_GUEST_LOGIN','Guest login');
define('TEXT_GUEST_LOGIN_INFO','Set up guest access to the app without entering a username and password. <a href="https://docs.rukovoditel.net/index.php?p=120" target="_blank"><u>Read more.</u></a>');
define('TEXT_ENABLE_GUEST_LOGIN','Enable guest login');
define('TEXT_LOGIN_AS_GUEST','Login as guest');
define('TEXT_GUEST_LOGIN_USER_INFO','Select the user who will automatically sign-in when guest login.');
define('TEXT_TREE_TABLE','Tree table');
define('TEXT_FIELDTYPE_NESTED_CALCULATIONS_TITLE','Nested Calculations');
define('TEXT_FIELDTYPE_NESTED_CALCULATIONS_TOOLTIP','A special type of field for performing calculations on nested records within a single tree branch in a tree list. <a href="https://docs.rukovoditel.net/index.php?p=123" target="_blank"><u>Read more.</u></a>'
        . '<p><b>Please note:</b> calculations are performed only when adding/editing a record in a specific branch of the tree.</p>');
define('TEXT_FUNCTION','Function');
define('TEXT_PERFORM_CALCULATION','Perform calculation');
define('TEXT_ONLY_AT_THE_TOP_LEVEL','Only at the top level');
define('TEXT_ALL_OVER_TREE_BRANCH','All over the tree branch');
define('TEXT_FUNCTION_SUM','SUM - calculate the sum of values');
define('TEXT_FUNCTION_COUNT','COUNT - count all elements');
define('TEXT_DISPLAY_NESTED_RECORDS','Display nested records');
define('TEXT_CHANGE_PARENT_ITEM','Change parent record');

//new defines for version 3.0
define('TEXT_UNIQUE_FOR_EACH_PARENT_RECORD','Unique for each parent record');
define('TEXT_IS_UNIQUE','Is Unique?');
define('TEXT_ENTITIES_GROUPS','Entities groups');
define('TEXT_ENTITIES_GROUPS_INFO','You can split and filter entities by groups.');
define('TEXT_GROUP','Group');
define('TEXT_STRONG_PASSWORD','Strong password');
define('TEXT_STRONG_PASSWORD_TIP','Password must contains: digits, uppercase characters and special characters.');
define('TEXT_KEEP_CURRENT_FORM_OPEN','Keep current form open');
define('TEXT_SAVE_AND_CLOSE','Save & close');
define('TEXT_EDITABLE_FIELDS_IN_LISTING','Editable fields in listing');
define('TEXT_EDITABLE_FIELDS_IN_LISTING_INFO','User can change single field value by clicking on table cell.');
define('TEXT_COLLAPSED','Collapsed');
define('TEXT_ALLOW_CHANGE_FILE_NAME','Allow change file name');
define('TEXT_DROP_DOWN_MENU_ON_HOVER','Drop-down menu on mouse hover');
define('TEXT_YOU_CANT_DELETE_FIELD','You can\'t delete a field "%s".');
define('TEXT_FIELD_USING_IN_FORMULA','Field is using in formula');
define('TEXT_DELETE_FIELD_WARNING','<b>Warning:</b> deleting a field will delete all data associated with that field in the database.');
...
define('TEXT_EXCLUDE_VALUES_NOT_IN_LISTING','Exclude values that are not in records listing');
define('TEXT_FIELDTYPE_COLOR_TITLE','Color Selection');
define('TEXT_FIELDTYPE_COLOR_TOOLTIP','Displays the colors that have been configured for the options directly in the drop-down list.');
...
define('TEXT_DISABLE_USER_AVATAR','Disable user avatar');
define('TEXT_CURRENT_USER_GROUP','Current user group');
define('TEXT_CUSTOM_HTML','Custom HTML');
define('TEXT_CUSTOM_HTML_INFO','Add custom code in head and body tags. The code sections only support HTML, CSS, and JS.');
define('TEXT_ADD_CODE_END_OF_HEAD','Add code at the end of <head> tag');
define('TEXT_ADD_CODE_BEFORE_BODY','Add code before </body> tag');
define('TEXT_RESET_SORTING','Reset sorting');
define('TEXT_VALUES_WILL_SORTED_BY_NAME','The values will be sorted by name');
define('TEXT_DISPLAY_PARENT_NAME','Display parent name');
define('TEXT_SELECT_ALL_RECORDS','Select all records');
define('TEXT_ON_CURRENT_PAGE_ONLY','On current page only');
define('TEXT_SELECTED_RECORDS','Selected records: <b>%s</b>');
define('TEXT_RESET_SELECTION','Reset selection');
define('TEXT_FIELDTYPE_AUTOSTATUS_ACTION_TIP','You have the opportunity to connect the process of automation to every Status. If a process is selected, it will be auto executed when selected status is set.');
define('VALUE_FROM_PARENT_ENTITY','Value from  parent entity');
define('TEXT_FIELDTYPE_ENTITY_MULTILEVEL_PARENT_FIELD_VALUE_TIP','If you have created a separate field in which you select a value from the parent entity, select this field to establish a relationship with the lists. <a href="https://docs.rukovoditel.net/index.php?p=126" target="_blank"><u>Read more.</u></a>');
define('TEXT_TEXT','Text');
define('TEXT_BACKGROUND','Background');
define('TEXT_SAVE_AS','Save as');
define("TEXT_ADD_RECORDS_TO_FAVORITES","Add records to Favorites");
define('TEXT_ADD_RECORDS_TO_FAVORITES_TIP','The star icon will appear on the entries page, which allows users to add entries to favorites. <a href="https://docs.rukovoditel.net/index.php?p=127" target="_blank"><u>Read more.</u></a>');
define('TEXT_FAVORITES','Favorites');
define('TEXT_DISPLAYED','Displayed');
define('TEXT_DISPLAY_SEARCH_BAR','Display search bar');
define('TEXT_FIELDTYPE_IMAGE_MAP_NESTED_TITLE','Image Map for nested records');
define('TEXT_FIELDTYPE_IMAGE_MAP_NESTED_TOOLTIP','A special type of field for displaying custom maps. Users will be able to upload their own map images. Markers on the map are records from a nested entity. <a href="https://docs.rukovoditel.net/index.php?p=18" target="_blank"><u>Read more.</u></a>');
define('TEXT_HIDDEN_FIELDS_IN_FORM','Hidden fields in form');
define('TEXT_HIDDEN_FIELDS_IN_FORM_TIP','You can hide technical fields for all users groups except admins.');
define('TEXT_ALL_STAGES','All Stages');
define('TEXT_CONSISTENTLY','Consistently');
define('TEXT_BRANCHING','Branching');
define('TEXT_FIELDTYPE_STAGES_SHOW_CONSISTENTLY_TIP','Display only one stage after current');
define('TEXT_FIELDTYPE_STAGES_SHOW_BRANCHING_TIP','Only the current branch in the stage tree is displayed.');
define('TEXT_GLOBAL_VARS','Global Variables');
define('TEXT_GLOBAL_VARS_INFO','Create global constants that can be used in your own PHP code or MySQL Formula  field type. <a href="https://docs.rukovoditel.net/index.php?p=128" target="_blank"><u>Read more.</u></a>');
define('TEXT_ADD_FOLDER','Add Folder');
define('TEXT_CUSTOM_PHP','Custom PHP');
define('TEXT_CUSTOM_PHP_INFO','Create your own Functions and Classes that can be used in PHP Code field or PHP code in Processes. <a href="https://docs.rukovoditel.net/index.php?p=129" target="_blank"><u>Read more.</u></a>');
define('TEXT_F11_FULLSCREEN','F11 - Full Screen');
define('TEXT_DISABLE','Disable');
define('TEXT_DISPLAYS_AS_TAB','Displays as Tab');
define('TEXT_AUTO_BACKUP','Auto Backup');
define('TEXT_AUTOMATIC_BACKUP','Automatic backup');
define('TEXT_AUTOMATIC_BACKUP_INFO','To run scheduled backups, you need to set up a scheduled task (cron) in your hosting control panel.');
define('TEXT_KEEP_FIELS','Keep files');
define('TEXT_ENTER_NUMBER_OF_DAYS','Enter the number of days');
define('TEXT_FORM_WIZARD','Form Wizard');
define('TEXT_TAB_GROUPS','Tab Groups');
define('TEXT_TAB_GROUPS_INFO','If there are a large number of tabs, then to save space in the form, you can group the tabs. <a href="https://docs.rukovoditel.net/index.php?p=64" target="_blank"><u>Read more.</u></a>');
define('TEXT_FORM_WIZARD_INFO','Split data entry by Steps using Tabs. If this option enabled, the user have to enter data step by step. The Save button displays on last the Tab in this case. <a href="https://docs.rukovoditel.net/index.php?p=130" target="_blank"><u>Read more.</u></a>');
define('TEXT_NEXT','Next');
define('TEXT_PREVIOUS','Previous');
define('TEXT_OF','of');

//new defines for version 3.1
define('TEXT_EMAILS_LAYOUT','Email layout');
define('TEXT_EMAILS_LAYOUT_INFO','Create a HTML layout for emails in the app. <a href="https://docs.rukovoditel.net/index.php?p=132" target="_blank"><u>Read more.</u></a>');
define('TEXT_SEND_TEST_EMAIL_INFO','Email with subject "%s" will be sent to:');
...
define('TEXT_MYSQL_QUERY','MySQL query');
define('TEXT_USE_HTML_EDITOR','Use HTML editor');
define('TEXT_EMPTY_VALUE','Empty value');
define('TEXT_AVAILABLE_VALUES','Available values');
define('TEXT_FIELDTYPE_YANDEX_MAP_TITLE','Yandex Map');
define('TEXT_FIELDTYPE_YANDEX_MAP_TOOLTIP','Field to display the marker on the map. The coordinates of the marker are determined automatically by the entered address.');
...
define('TEXT_GELIOSSOFT_ENABLE','Enable integration with GeliosSoft');
define('TEXT_SPEED','Speed');
define('TEXT_SPEED_KPH','kph');
define('TEXT_DATA_REFRESH_INTERVAL','Data refresh interval');
define('TEXT_SECONDS','Seconds');
define('TEXT_LAST_MESSAGE','Last message');
define('TEXT_DATEPICKER_DAYS_HOURS_MINUTES_SHORT','"d.","h.","m.","s."');
define('TEXT_AGO','ago');
define('TEXT_SIDEBAR_WIDTH','Sidebar width');
define('TEXT_CARS','Cars');
define('TEXT_SHOW_WEEK_NUMBERS','Show week numbers');
define('TEXT_FIELDTYPE_INPUT_DATE_EXTRA_TITLE','Calendar extended');
define('TEXT_FIELDTYPE_INPUT_DATE_EXTRA_TOOLTIP','Calendar for selecting date and time, which has a number of additional display settings. <a href="https://docs.rukovoditel.net/index.php?p=137" target="_blank"><u>Read more.</u></a>');
define('TEXT_MINIMUM_TIME','Minimum time');
define('TEXT_MAXIMUM_TIME','Maximum time');
define('TEXT_ALLOWED_TIME','Allowed time');
define('TEXT_FORMAT','Format');
define('TEXT_DISABLED_DATES','Disabled dates');
define('TEXT_DISABLED_WEEK_DAYS','Disabled week days');
define('TEXT_DISABLED_DATES_BY_QUERY','Disabled dates by SQL query');
define('TEXT_FIELDTYPE_YANDEX_MAP_DIRECTIONS_TITLE','Yandex Map Directions');
define('TEXT_FIELDTYPE_YANDEX_MAP_DIRECTIONS_TOOLTIP','Field to display multiple markers on the map. The coordinates of the markers are determined automatically by the entered addresses. The specified markers can be used to create a route.');
define('TEXT_FIELDTYPE_YANDEX_MAP_NESTED_TITLE','Yandex Map Directions (Nested entity)');
define('TEXT_FIELDTYPE_YANDEX_MAP_NESTED_TOOLTIP','The route will be built by addresses from the nested entity.');
define('TEXT_WINDOW','Window');
define('TEXT_LOGS','Logs');
define('TEXT_STORE_IN_DB','Store in database');
define('TEXT_RECORDS_VISIBILITY_SQL_QUERY_INFO','Add your own query that will be included in Records Visibility Rules');
define('TEXT_ERRORS','Errors');
define('TEXT_ALL','All');
define('TEXT_REFRESH','Refresh');
define('TEXT_DISPLAY_AS_DROPDOWN_AJAX_TIP','With a large number of buttons in the list, it is recommended to use an ajax drop down. This reduces the load on the server.');
define('TEXT_LOGS_INFO','Attention: do not leave the logs permanently enabled, as they create an additional load on the server. <a href="https://docs.rukovoditel.net/index.php?p=138" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_GOOGLE_MAP_NESTED_TITLE','Google Map Directions (Nested entity)');
define('TEXT_FIELDTYPE_GOOGLE_MAP_NESTED_TOOLTIP','The route will be built by addresses from the nested entity.');
define('TEXT_DATE','Date');
define('TEXT_VALUE_FROM_SQL_TIP','Enter the field name from the sql query.');
define('TEXT_CALCULATOR','Calculator');
define('TEXT_DATA_IN_BORWSER_CONSOLE','The data is displayed in the browser console.');
...
define('TEXT_START_IMPORT_FROM_LINE','Start import from line');
define('TEXT_TEXT_SELECT_ALL_TIP','If entered, user can click on it and select all values in list.');
define('TEXT_EVERY_DAY','Every day');
define('TEXT_EXTENDED','Extended');
define('TEXT_NAME_ON_MOBILE_DEVICE','Name on mobile device');
define('TEXT_HIDE_IF_EMPTY','Hide if no records');
define('TEXT_NESTED_ENTITIES_MENU','Nested entities menu');
define('TEXT_NESTED_ENTITIES_MENU_INFO','In order to save space on the page, you can combine entities into groups. <a href="https://docs.rukovoditel.net/index.php?p=144" target="_blank"><u>Read more.</u></a>');
define('TEXT_ICON_COLOR','Icon color');
define('TEXT_TEXT_COPIED','Text copied');
define('TEXT_DOCS_PREVIEW','Document preview');
...
<p>Rukovoditel is free Open Source software distributed under the terms of the <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.html">GNU GPLv3</a></p>
<p>The author and copyright holder of the program are:</p>
<ul>
...
define('TEXT_SORT_BY_FIELD','Sort by field');
define('TEXT_GROUP_BY_FIELD','Group by field');
define('TEXT_AUDIO_RECORDING','Audio recording');
define('TEXT_ALLOW_AUDIO_RECORDING','Allow audio recording');
define('TEXT_ALLOW_AUDIO_RECORDING_INFO','Microphone icon will be appear near attachments button');
define('TEXT_AUDIO_RECORDING_LENGTH','Audio recording length');
define('TEXT_AUDIO_RECORDING_LENGTH_INFO','Limit the length of the audio recording in minutes.');
define('TEXT_RECORD','Record');
define('TEXT_PAUSE','Pause');
define('TEXT_STOP','Stop');
define('TEXT_RESUME','Resume');
define('TEXT_AUDIO_RECORD','Audio record');
define('TEXT_START_RECORDING','Start recording');
define('TEXT_FIELDTYPE_ONLYOFFICE_TITLE','ONLYOFFICE Server');
define('TEXT_FIELDTYPE_ONLYOFFICE_TOOLTIP','Uploaded files can be viewed and modified using the ONLYOFFICE Document Editor. Access to the ONLYOFFICE server is required for this field to work. <a href="https://docs.rukovoditel.net/index.php?p=149" target="_blank"><u>Read more.</u></a>');
define('TEXT_URL_TO_JS_API','Url to  API JavaScript');
define('TEXT_ONLYOFFICE_API_JS_INFO','Where <b>documentserver</b> is the name of the server with the ONLYOFFICE Document Server installed.');
define('TEXT_ONLYOFFICE_SECRET_KEY_INFO','The secret key is used to sign the JSON web token and validate the token upon the request to ONLYOFFICE Docs. <a href="https://helpcenter.onlyoffice.com/installation/docs-configure-jwt.aspx" target="_blank"><u>Read more.</u></a>');
define('TEXT_DELETE_FILE','Delete file');
define('TEXT_REGION','Region');
define('TEXT_ALLOW_EDIT_DOCUEMENT','Allow editing of document');
define('TEXT_USERS_WITH_VIEW_ACCESS','Users with access to view the record');
define('TEXT_USERS_WITH_EDIT_ACCESS','Users with access to edit a record');
define('TEXT_ASSIGNED_USERS','Assigned users');
define('TEXT_SPECIFY_REQUIRED_FIELDS','Specify required fields');
define('TEXT_DISABLE_EMAIL_NOTIFICATIONS_TIP','Only default email notifications will be disabled. The email rules will still work.');
define('TEXT_DATE_RANGE','Date range');
define('TEXT_MERGE_VALUE','Merge value');
define('TEXT_EXCLUDE_VALUE','Exclude value');
define('TEXT_PREVKOUS_VALUE','Previous value');
define('TEXT_WEB_APPLICATION_ICONS','Web Application Icons');
define('TEXT_ACCESSIBILITY_ICONS','Accessibility Icons');
define('TEXT_HAND_ICONS','Hand Icons');
define('TEXT_TRANSPORTATION_ICONS','Transportation Icons');
define('TEXT_GENDER_ICONS','Gender Icons');
define('TEXT_FILE_TYPE_ICONS','File Type Icons');
define('TEXT_SPINNER_ICONS','Spinner Icons');
define('TEXT_FORM_CONTROL_ICONS','Form Control Icons');
define('TEXT_PAYMENT_ICONS','Payment Icons');
define('TEXT_CHART_ICONS','Chart Icons');
define('TEXT_CURRENCY_ICONS','Currency Icons');
define('TEXT_TEXT_EDITOR_ICONS','Text Editor Icons');
define('TEXT_DIRECTIONAL_ICONS','Directional Icons');
define('TEXT_VIDEO_PLAYER_ICONS','Video Player Icons');
define('TEXT_CANT_DELTE_ITEM','The item cannot be deleted.');
define('TEXT_LIST_USED_WARN','The list is used in the following fields:');
define('TEXT_FILE_STORAGE','File storage');
define('TEXT_FIELDTYPE_DROPBOX_TITLE','Dropbox');
define('TEXT_ACCESS_TOKEN','Access token');
define('TEXT_ROOT_FOLDER','Root folder');
define('TEXT_APP_CODE','App Code');
define('TEXT_APP_KEY','App key');
define('TEXT_APP_TOKEN','App token');
define('TEXT_GET_VALUE','Get value');
define('TEXT_CHECK_FIELD_SETTINGS','Check the field settings.');
define('TEXT_FIELDTYPE_YANDEX_DISK_TITLE','Yandex Disk');
define('TEXT_OAUTH_TOKEN','OAuth token');
define('TEXT_CLIENTID','ClientID');
define('TEXT_ROOT_FOLDER_FILE_STORAGE_WARN','If you change the name of root folder, you need to manually change the name in the file storage service.');
define('TEXT_FILE_STORAGE_TOOLTIP','A special field that allows you to upload files to the file storage service. <a href="https://docs.rukovoditel.net/index.php?p=150" target="_blank"><u>Read more.</u></a>');
define('TEXT_PRIVATE_KEY_FILENAME','Private key filename');
define('TEXT_PRIVATE_KEY_FILENAME_TIP','Create private key for your Service Account in JSON format. Load JSON file in <code>config/</code> folder.');
define('TEXT_FIELDTYPE_GOOGLE_DRIVE_TITLE','Google Drive');
define('TEXT_FIELDTYPE_GOOGLE_DRIVE_ROOT_FOLDER','Google Drive Folder ID');
define('TEXT_FIELDTYPE_GOOGLE_DRIVE_ROOT_FOLDER_TIP','Create a new folder to contain the files. You can find the folder ID in the page URL. <code>Note:</code> Access to the folder must be granted to your service account.');
define('TEXT_FIELDTYPE_GOOGLE_DRIVE_TOOLTIP','A special field that allows you to upload files to the file storage service Google Disk. <a href="https://docs.rukovoditel.net/index.php?p=153" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_DROPBOX_TOOLTIP','A special field that allows you to upload files to the file storage service Dropbox. <a href="https://docs.rukovoditel.net/index.php?p=152" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_YANDEX_DISK_TOOLTIP','A special field that allows you to upload files to the file storage service Yandex Disk. <a href="https://docs.rukovoditel.net/index.php?p=151" target="_blank"><u>Read more.</u></a>');

//new defines for version 3.6
define('TEXT_CURRENT_APP_VERSION', 'App Version');
define('TEXT_UPDATE_INSTRUCTION','<a href="https://docs.rukovoditel.net/index.php?p=63" target="_blank"><i class="fa fa-hand-o-right"></i> Update Instructions</a>');
define('TEXT_COMPOSITE_UNIQUE_FIELDS','Composite unique fields');
define('TEXT_COMPOSITE_UNIQUE_FIELDS_INFO','This functionality is designed to combine unique fields into groups.  The uniqueness check will be performed for the group, the fields are compared in pairs. You do not need to set the uniqueness flag for a separate field. <a href="https://docs.rukovoditel.net/index.php?p=160" target="_blank"><u>Read more.</u></a>');
define('TEXT_COMPOSITE_UNIQUE_MESSAGE_TIP','Use the constants <code>[f1]</code>, <code>[f2]</code> to insert the field values into the message.<br>The constants <code>[f1_in]</code> and <code>[f2_in]</code> are used if fields with multiple values are being compared. These constants contain values that overlap.');
define('TEXT_MESSAGE_TEXT','Message text');
define('TEXT_YANDEX_SMARTCAPTCHA_HOW_ENABLE','To enable, open the file "config/security.php" change CFG_YANDEX_SMARTCAPTCHA_ENABLE to "true", enter key in CFG_YANDEX_SMARTCAPTCHA_KEY and secret key in CFG_YANDEX_SMARTCAPTCHA_SECRET_KEY.');
define('TEXT_WHO_IS_ONLINE','Who is online');
define('TEXT_ONLINE','Online');
define('TEXT_OFFLINE','Offline');
define('TEXT_ENABLE_WHO_IS_ONLINE_REPORT','Enable the "Who is Online" report');
define('TEXT_ENABLE_WHO_IS_ONLINE_REPORT_TIP','If enabled, the "Who is online" page will appear in the "Tools" menu.');
define('TEXT_STATUS_UPDATE_TIME','Status update time');
define('TEXT_IN_MINUTES','In minutes');
define('TEXT_AUTO_LOGOUT_INACTION_USERS','Automatic logout for inactive users');
define('TEXT_TIME_WITHOUT_ACTION','Time without action');
define('TEXT_BLOCK_RECORD_FORM_WHEN_EDITING','Block the record form when editing');
define('TEXT_BLOCK_RECORD_FORM_WHEN_EDITING_INFO','If the user has started making changes, editing will not be available to another user.<br>This rule applies to all forms of entity and forms of automation.');
define('TEXT_FORM_BLOCKED_WARNING','The form is blocked. <b>[user_name]</b> makes changes.<br>Please try again later.');
define('TEXT_NEGATIVE_NUMBER_COLOR','Color of the negative number');
define('TEXT_HIDE_PAGE_TITLE','Hide page title');
define('TEXT_HIDE_PRINT_BUTTON','Hide print button');
define('TEXT_CURRENT_YEAR','Current year');
define('TEXT_MAXIMUM_NUMBER_OF_FIELS_TO_UPLOAD','Maximum number of files to upload');
define('TEXT_UPDATE_BY_CREATOR_ONLY','Update by creator only');
define('TEXT_LOGIN_ATTEMPT_INFO','On this page you can limit the number of login attempts. After unsuccessful login attempts, the user\'s IP address will be temporarily blocked.');
define('TEXT_NUMBER_LOGIN_ATTEMPTS','Number of login attempts');
define('TEXT_NUMBER_LOGIN_ATTEMPTS_TIP','The number of login attempts allowed during the specified period.');
define('TEXT_NUMBER_MINUTES','Number of minutes');
define('TEXT_NUMBER_MINUTES_IP_BLOCKED_TIP','The number of minutes the IP address will be blocked for.');
define('TEXT_LOGIN_ATTEMPT_VERIFY_ERROR','The number of login attempts is limited. Please try again later.');
define('TEXT_RESTRICTIONS','Restrictions');
define('TEXT_DO_NOT_APPLY_RESTRICTIONS_FOR','Do not apply restrictions for');
define('TEXT_VIEW_PLUS_DISPLAY_IN_FORM','View + display in form');
define('TEXT_MAXLENGTH','Max Characters');
define('TEXT_MAXLENGTH_TIP','Set the maximum number of characters allowed.');
define('TEXT_TRUSTED_IP','Trusted IP addresses');
define('TEXT_TRUSTED_IP_TIP','Enter IPs by comma. The check will not be applied to the IP addresses entered.');
define('TEXT_FIELD_DOES_NOT_EXIST_ERROR','Error: The "%s" field is missing in the "%s" entity.');
define('TEXT_COPY_GROUP_QUESTION','Copy the "%s" group?');
define('TEXT_COPY_GROUP_TIP','Enter the details of the new group. Access rights to entities, fields and comments will be copied from the "%s" group.');
define('TEXT_LIMIT_LIST','Limit the list');
define('TEXT_LIMIT_LIST_INFO','Select a group of users or specific users that will be available in the list.');
define('TEXT_USE_CANCEL_BUTTON','Use "Cancel" button');
define('TEXT_FIELDTYPE_USERS_APPROVE_CANCEL_BTN_TIP','Users can undo an action that has been performed.');
define('TEXT_HIDE_BUTTON','Hide button');
define('TEXT_FIELDTYPE_USERS_APPROVE_HIDE_CANCEL_BTN_TIP','Select the field and the values at which the button "Cancel" will be hidden.');
define('TEXT_DELETE_BTN','Delete button');
define('TEXT_USE_DELETE_BUTTON','Use "Delete" button');
define('TEXT_ANY_USERS','Any users');
define('TEXT_FIELDTYPE_SIGNATURE_FILTERS_TIP','By default, the button is available to all users. Click on the name of the field in the list to adjust the conditions for displaying the button.');
define('TEXT_MY_CURRENT_SIGNATURE', 'My current signature');
define('TEXT_USE_ID_FEM','Use it');
define('TEXT_DISPLAY_USER_CURRENT_SIGNATURE','Display current user signature');
define('TEXT_DISPLAY_USER_CURRENT_SIGNATURE_TIP','If previously user sign any item, he can use own signature in next time by single click on it.');
define('TEXT_SELECT_USER_GROUP_FOR_RULE','Select the user groups for which the rule will be applied. By default for all users.');
define('TEXT_ALL_USERS','All users');
define('TEXT_RESET_TO_DEFAULT','Reset to default');
define('TEXT_SET_MSG_FILTERS','Set filters under which the message will be sent.');
